...
Route::delete('/remove/{id}', 'VideoController@remove')->middleware(ApiAuthMiddleware::class);
Route::put('/video/update/{id}', 'VideoController@update')->middleware(ApiAuthMiddleware::class);
